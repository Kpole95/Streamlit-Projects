...
st.write("""
    Hey there! This app’s all about figuring out how many bikes get rented in Seoul. We’ve got data on rentals, weather, and more, and we’ll dig into it with cool charts, tweak some fancy models, and even let you predict rentals yourself. I’ll walk you through each part so it all makes sense—let’s dive in!
""")
...
st.markdown("""
    ...
    **How do we pull it off?**  
    ...
    - We also save it in memory with this `@st.cache_data` trick so it loads fast next time.
...
use_log = st.checkbox("Use Log Target", 
                     help="Tick this if you want to predict the smoothed-out version of rentals—it helps when there’s a few crazy high days.")
...
with tab0:
    ...
    st.write("""
        These histograms are like a bar graph showing how often each number shows up—like how many days had 100 rentals or 20°C temps. Tall bars mean common values; long tails mean some wild ones.
    """)
